...
export const Header = () => {
  return (
    <header className='sticky left-0 top-0 z-[110] py-3 flex w-full flex-col border-b border-border bg-surface-primary dark:border-[--dark-border] dark:bg-[--dark-surface-primary]'>
